...
//{{{ begin codeInclude
#line 21 "/scratch/gpfs/mj6792/PETSc_benchmark/shercliff/FOAM_ictc_infopcg/system/liquid/codeDict.outletUxB"
#include "scalar.H"
        #include "fvCFD.H"
...
//{{{ begin code
    #line 35 "/scratch/gpfs/mj6792/PETSc_benchmark/shercliff/FOAM_ictc_infopcg/system/liquid/codeDict.outletUxB"
